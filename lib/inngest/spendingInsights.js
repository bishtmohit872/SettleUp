        ...
        for(const user of users){
            ...
            const expenseData = JSON.stringify({
             ...
             const prompt = `
                            ...
                            Focus on spending patterns, category breakdowns, and actionable advice for better financial management. And give each section that i mentioned you, in table form for better understanding of user, and don't put dollar symbol in front of amount, put indian ruppee symbol in front of amount.
            ...
            try{
                ...
                await step.run(`Email - ${user._id}`,()=>{
                    convex.action(api.email.sendEmail,{
                        to:user.email,
                        subject:"Your Spending Recap for the Month",
                        html:`
                            <h1>Your Spending Recap</h1>
                            <p>Hi ${user.name},</p>
                            <p>Here’s how your money moved in the past month</p>
                            ${htmlBody} `,
